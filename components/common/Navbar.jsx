    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            title: "Prospecting",
            imgSrc: "/st-images/menu-icon-1.png",
            desc: "Advanced targeting and popular link prospecting tactics",
            href: "/product/link-building-prospecting",
          },
          {
            title: "Outreach & Follow Up",
            imgSrc: "/st-images/menu-icon-5.png",
            desc: "Keep the outreach going with automatic follow-ups",
            href: "/product/outreach-follow-up",
          },
          {
            title: "AI Tools for Link Building",
            imgSrc: "/st-images/pb-plans-pricing-2.png",
            desc: "AI Personalization, AI Template Assistant, AI Reply and more",
            href: "/ai",
          },
          {
          ...
          },
          {
            ...
            desc: "Segment your team's work so they can stay in the zone",
            href: "/product/skill-based-workflow",
          },
          {
            title: "Reports",
            ...
            <nav className="flex items-center space-x-6">
              {navbarMenuItems.map((item, index) => (
                ...
                >
                  ...
                  {item.hasDropdown ? (
                    <button
                      className={`flex text-[14px] font-medium items-center space-x-1 hover:text-blue-400 transition-colors duration-200 py-2 cursor-pointer ${
                  ...
                  {item.hasDropdown && activeDropdown === item.label && (
                    <div className="absolute left-0 top-12 z-50 transition-all duration-200">
                      {item.megaMenu ? (
                        <div className="rounded-lg shadow-xl w-[800px] bg-white border border-gray-100">
                        ...
                        <div className="rounded-lg shadow-xl py-2 w-80 bg-white border border-gray-100">
                          <div className="space-y-1">
