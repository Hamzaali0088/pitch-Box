...
const Hero = () => {
    const words = ["SEO Agencies", "Bloggers", "Marketers", "Publishers"];
    ...
    return (
        <FullContainer className="bg-black relative pt-32">
            <Image src="/st-images/background-image.jpg" alt="link binding" width={2000} height={2000} className="w-full h-full object-cover absolute top-0 left-0   " />
                    ...
                    <div className="flex flex-col items-center justify-between gap-10 pt-20">
                        ...
                        <div className="text-center">
                            <h1 className="text-3xl sm:text-4xl tracking-wide text-white text-center">
                                All-In-One Link Building Software for <br />
                                <span className="">
                                    {displayedText}
                                    <span>|</span>
                                </span>
                        ...
                        <div className="w-full ">
                            <Image src="/st-images/pb-homepage-v3-short-playbtn-kr.jpg" alt="link binding" width={2000} height={2000} className="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
            </Container >
